...
### Follow-up (uncommitted): Substack
- Shared `SUBSTACK_URL` in `src/lib/routes.ts`
- Linked from homepage `BlogSection`, `/blog`, navbar, and footer
- Build + lint still pass locally after change
