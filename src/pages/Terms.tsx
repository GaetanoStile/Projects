      ...
      <section className="px-4 pb-20 pt-16 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 leading-8 text-white/72">
            This placeholder terms page is ready for product policy copy covering eligibility, acceptable use,
            ownership, subscriptions, and any brand-specific rules you want in place before launch.
          </p>
        </motion.div>
      </section>
    </MarketingLayout>
