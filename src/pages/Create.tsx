              ...
              <button
                ...
                className={`px-6 py-3 font-display text-lg transition-colors ${
                  activeTab === 'custom'
                    ...
                    : 'text-velvet/60 hover:text-velvet'
                }`}
              >
                Custom Only
              </button>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 rounded-lg border-2 border-gold/30 bg-white/90 text-velvet font-body focus:outline-none focus:border-gold"
                    >
                      <option value="all">All Decks</option>
                      <option value="A">Deck A</option>
                      <option value="B">Deck B</option>
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <button
                        ...
                        className="text-velvet hover:text-gold transition-colors text-2xl"
                      >
                        ×
                      </button>
                    </div>
                    ...
                    <form onSubmit={editForm.handleSubmit(handleEditSubmit)} className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="edit-title" className="block text-velvet font-body font-semibold mb-2 text-left">
                            Title
                          </label>
                          <input
                            id="edit-title"
                        ...
                        <div>
                          <label htmlFor="edit-deck" className="block text-velvet font-body font-semibold mb-2 text-left">
                            Deck
                          </label>
                          <select
                            id="edit-deck"
                      ...
                      <div>
                        <label htmlFor="edit-description" className="block text-velvet font-body font-semibold mb-2 text-left">
                          Description
                        </label>
                        <textarea
                          id="edit-description"
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="edit-player-color" className="block text-velvet font-body font-semibold mb-2 text-left">
                            Player Color
                          </label>
                          <select
